...
root.title("DISEASE PREDICATION")
...
# Heading
w2 = Label(root, justify=CENTER, text="Disease Prediction using Machine Learning", fg="white", bg="green")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=1, columnspan=2, padx=100)
w2 = Label(root, justify=CENTER, text="Project", fg="white", bg="sky blue")
w2.config(font=("Lucida Bright", 30,"bold"))
...
b2 = Button(root, text="Back To Login",command=backtologin,font=("Arial",12), bg="green",bd=10)
b2.place(x=1150, y=350,width=150)
